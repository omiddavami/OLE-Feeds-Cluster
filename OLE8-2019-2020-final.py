...
dfsegment = spark.read.csv("/reactor/davami/INRIX_XDSegments_18_2.csv", inferSchema=True, header=True)

# COMMAND ----------

dfinrix = spark.read.csv("/reactor/INRIX_new/2019/04/04-01-2019.csv", inferSchema=True, header=True)
