...
dfinrix = spark.read.csv("/reactor/davami/11-4-2018small.csv", inferSchema=True, header=True)
...
dffinal2.coalesce(1).write.csv("/reactor/davami/olefeed3/", header =True)
